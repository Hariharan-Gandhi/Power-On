...
jQuery.sap.declare("teched.poweron.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("teched.poweron.Component", {
	metadata: {
		"name": "PowerOn",
		"version": "1.1.0-SNAPSHOT",
		"library": "teched.poweron",
	...
	createContent: function() {
		...
		return sap.ui.view({
			viewName: "teched.poweron.view.Main",
	...
	init: function() {
		...
		var sRootPath = jQuery.sap.getModulePath("teched.poweron");
	...
	_initODataModel: function(sServiceUrl) {
		jQuery.sap.require("teched.poweron.util.messages");
		var oConfig = {
			metadataUrlParams: {},
			json: true,
		...
		oModel.attachRequestFailed(null, teched.poweron.util.messages.showErrorMessage);
